...
%
% Verified 2026-07-25: wires resolve to sharp discrete points, matching
% DAS positions, with a visibly cleaner noise floor than DAS, consistent
% with f-k migration's known image quality advantage over delay-and-sum.
...
%% ---- F-K migration reconstruction (verified 2026-07-25) ----
fprintf('Running f-k migration (verified)...\n');
tic;
...
saveas(gcf, fullfile(figOutputFolder, 'das_vs_fk_migration.png'));
