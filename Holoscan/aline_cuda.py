...
Matches the real generated signature from aline_reconstruct.h:
...
The .lib produced directly by GPU Coder on Windows cannot be loaded here --
see the build instructions accompanying this file.
"""
import ctypes
import numpy as np
import os
...
if os.path.isfile(_LIB_PATH):
    ...
    _lib.aline_reconstruct.restype = None
